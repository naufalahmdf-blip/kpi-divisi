...
import EmployeeProfileModal, { EmployeeData } from './EmployeeProfileModal';
...
export default function DivisionDetailModal({ open, onClose, divisionId, periodParams }: DivisionDetailModalProps) {
  ...
  return (
    <>
                ...
                <div className="space-y-2">
                  {data.members.map((member, i) => (
                    <div
                      ...
                      className="flex items-center gap-3 p-3 bg-white/[0.02] rounded-xl border border-white/[0.04] hover:bg-white/[0.04] transition-colors cursor-pointer"
                    >
                      <div className={cn(
      ...
      {/* Employee Profile Modal - stacked on top */}
